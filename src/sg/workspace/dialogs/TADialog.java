...
public class TADialog extends Stage {
    ...
    public TADialog(SiteGeneratorApp initApp) {
    ...
    private void processDataChange() {
        ...
        SiteGeneratorFoolproofDesign fP = new SiteGeneratorFoolproofDesign(app);
    ...
    private void processCompleteWork() {
        ...
        EditTA_Transaction transaction = new EditTA_Transaction(taToEdit, name, email, type.toString(), (SiteGeneratorData)app.getDataComponent());
