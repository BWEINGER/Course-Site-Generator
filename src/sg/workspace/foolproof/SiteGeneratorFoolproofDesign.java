...
import static sg.workspace.style.SGStyle.CLASS_OH_TEXT_FIELD;
import static sg.workspace.style.SGStyle.CLASS_OH_TEXT_FIELD_ERROR;

public class SiteGeneratorFoolproofDesign implements FoolproofDesign {

    SiteGeneratorApp app;

    public SiteGeneratorFoolproofDesign(SiteGeneratorApp initApp) {
        app = initApp;
    }
