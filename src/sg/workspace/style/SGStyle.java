...
public class SGStyle {
    ...
    public static final String CLASS_BACKGROUND_PANE    = "background_pane";
    
    // FOR SITE TAB
    public static final String CLASS_SITE_PANE          = "site_pane";
    public static final String CLASS_SITE_BOX           = "site_box";
    ...
    public static final String CLASS_SITE_BOLD_LABEL    = "site_bold_label";
    public static final String CLASS_SITE_COMBO_BOX     = "site_combo_box";
    public static final String CLASS_SITE_CHECK_BOX     = "site_check_box";
    public static final String CLASS_SITE_BUTTON        = "site_button";
    public static final String CLASS_SITE_RADIO_BUTTON  = "site_radio_button";
    public static final String CLASS_SITE_IMAGE         = "site_image"; 
    public static final String CLASS_SITE_TEXT_AREA     = "site_text_area";
    public static final String CLASS_SITE_TABLE_VIEW    = "site_table_view";
    public static final String CLASS_SITE_DATE_PICKER   = "site_date_picker";
    
    // FOR SYL TAB
    public static final String CLASS_SYL_PANE          = "syl_pane";
    public static final String CLASS_SYL_BOX           = "syl_box";
    public static final String CLASS_SYL_BUTTON        = "syl_button";
    public static final String CLASS_SYL_LABEL         = "syl_label";
    public static final String CLASS_SYL_TEXT_AREA     = "syl_text_area";
