 ...
 * @author brettweinger
 */
public class ChangeEndDate_Transaction implements jTPS_Transaction {
    LocalDate oldDate;
    LocalDate newDate;
    ...
    public ChangeEndDate_Transaction(DatePicker initPicker, LocalDate initOld, LocalDate initNew, SiteGeneratorData initData, SiteGeneratorApp initApp, Button initButton) {
