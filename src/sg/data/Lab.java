...
public class Lab<E extends Comparable<E>> implements Comparable<E> {
     ...
     */
    public Lab(String initSection, String initDaysTime, String initRoom, String initTA1, String initTA2) {
    ...
    public int compareTo(E otherLab) {
        return getSection().compareToIgnoreCase(((Lab)otherLab).getSection());
    }
}
